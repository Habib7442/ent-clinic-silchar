   ...
   * ────────────────────────────────────────────────────────────────────── */
  {
    ...
    faqs: {
      ...
      bn: [
        ...
        {
          q: "শিশু কেন নাক ডাকে ও মুখ দিয়ে শ্বাস নেয়?",
          a: "সাধারণত অ্যাডেনয়েড ও/বা টনসিল বড় হওয়া। সঠিক নির্ণয়ে অনেক শিশু সার্জারি ছাড়াই ভালো হয়।",
        },
        {
          q: "কখন শ্রবণ পরীক্ষা করাব?",
          a: "কথায় দেরি, বারবার কানে ব্যথা, স্কুলে মনোযোগের সমস্যা বা পারিবারিক শ্রবণহানির ইতিহাস থাকলে।",
        },
        {
    ...
    faqs: {
      ...
      bn: [
        ...
        },
        {
          ...
          a: "হ্যাঁ — অ্যালার্জিক রাইনাইটিস শিশুদের সবচেয়ে সাধারণ দীর্ঘস্থায়ী সমস্যাগুলির একটি। বয়স-উপযুক্ত অ্যান্টিহিস্টামিন ও নাসাল স্প্রে পাওয়া যায়; ৫ বছর থেকে ইমিউনোথেরাপি বিবেচনা করা হয়।",
        },
        {
    ...
    faqs: {
      ...
      bn: [
        ...
        },
        {
          ...
          a: "দীর্ঘস্থায়ী পুঁজ পড়া — বিশেষত দুর্গন্ধযুক্ত বা শ্রবণহানির সঙ্গে — দ্রুত মূল্যায়ন করা উচিত। এটি কোলেস্টিয়াটোমাসহ দীর্ঘস্থায়ী ওটাইটিস মিডিয়ার লক্ষণ হতে পারে।",
        },
        {
